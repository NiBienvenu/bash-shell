...
# Dans le langage Bash, 
# une variable est un moyen de stocker des données sous un nom donné pour pouvoir les utiliser plus tard dans un script ou une session. 
# Les variables peuvent contenir différents types de données, comme des chaînes de caractères, des nombres, ou des résultats de commandes.

# Pour créer une variable, il suffit de l'assigner sans espaces autour du signe = :
